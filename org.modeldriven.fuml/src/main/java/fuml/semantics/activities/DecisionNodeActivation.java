...
public class DecisionNodeActivation extends
	...
	public fuml.semantics.commonbehavior.Execution decisionInputExecution = null;
	...
	public fuml.semantics.activities.ActivityEdgeInstance getDecisionInputFlowInstance() {
	...
	public fuml.semantics.activities.TokenList removeJoinedControlTokens(
			fuml.semantics.activities.TokenList incomingTokens) {
