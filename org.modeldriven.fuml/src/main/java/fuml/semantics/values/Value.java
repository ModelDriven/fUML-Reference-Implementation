...
public abstract class Value extends fuml.semantics.loci.SemanticVisitor {
	...
	public boolean hasType(fuml.syntax.classification.Classifier type) {
	...
	public boolean isInstanceOf(fuml.syntax.classification.Classifier classifier) {
	...
	public boolean checkAllParents(fuml.syntax.classification.Classifier type,
