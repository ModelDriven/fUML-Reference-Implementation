...
import fuml.syntax.actions.ExpansionNodeList;
...
public class ExpansionRegionActivation extends
	...
	public fuml.semantics.actions.ExpansionActivationGroupList activationGroups = new fuml.semantics.actions.ExpansionActivationGroupList();
	public fuml.semantics.actions.TokenSetList inputTokens = new fuml.semantics.actions.TokenSetList();
	public fuml.semantics.actions.TokenSetList inputExpansionTokens = new fuml.semantics.actions.TokenSetList();
	public int next = 0;
	...
	public void runGroup(
			fuml.semantics.actions.ExpansionActivationGroup activationGroup) {
	...
	public fuml.semantics.actions.ExpansionNodeActivation getExpansionNodeActivation(
			fuml.syntax.actions.ExpansionNode node) {
